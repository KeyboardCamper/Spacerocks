...
PROGMEM const char s0[] PROGMEM = "ASTEROIDS";
PROGMEM const char s1[] PROGMEM = "HIGH SCORES";
PROGMEM const char s2[] PROGMEM = "GAME";
PROGMEM const char s3[] PROGMEM = "OVER";
...
void playTone(unsigned int frequency, unsigned long duration_ms, byte priority) {
  ...
  display.tunes.tone(frequency, duration_ms);
}
